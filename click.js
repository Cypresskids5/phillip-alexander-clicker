...
let crystalClickSound = new Audio("./glass-smash-6266.mp3");
let portalsound = new Audio("./announcement-sound-3-21463.mp3");
let spinsound = new Audio("./spinner-sound-36693.mp3");
//Crystal clicking
...
spinner.addEventListener("click",()=>{
    ...
    setTimeout(() => {
        spinner.style.transform = "5s ease";
    }, 10000);
    setTimeout(() => {
        spinner.style.transform = "visible";
    }, 30000);
});
